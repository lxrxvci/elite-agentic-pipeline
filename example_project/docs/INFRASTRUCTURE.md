...
- **Pull requests** targeting `main` that touch `example_project/infra/**` or `example_project/observability/**` trigger `terraform plan`. The plan is posted as a PR comment.
