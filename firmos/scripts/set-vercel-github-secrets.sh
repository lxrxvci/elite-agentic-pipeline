...
# Project IDs created by the agentic pipeline setup.
BACKEND_ID="prj_D0CpuAXOsGlS7YFaBcxLxPeVxFa6"
FRONTEND_ID="prj_Q3zctiDsLvpDrIV6OUfV1cQlX9jb"
BACKEND_STAGING_ID="prj_UT1dKRlmpylItx7fgdmEeoqCgTde"
FRONTEND_STAGING_ID="prj_PHwrzmWbf2qaLkEi6OotpJerAsCF"
